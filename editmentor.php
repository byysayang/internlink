...
<head>
    ...
    <link rel="stylesheet" href="editmentor.css"/>
...
<?php
 include "koneksi.php";
 $id = $_GET['id_mentor'];
 $ambilData = mysqli_query($conn,"SELECT * FROM tb_mentor WHERE id_mentor='$id'");
...
<div class="input">
    <form action="" method="POST" class="form-item">
        <div class="form-group">
            ...
            <input type="text" name="nip" value="<?php echo $data['nip'] ?>" placeholder="Masukkan NIP MENTOR" style= "width: 74.5%;"></input>
        </div>
        <div class="form-group">
            <label for="nama_mentor"> NAMA MENTOR </label>
            <span style="margin-left: 3.5%"> : </span>
            <input type="text" name="nama_mentor" value="<?php echo $data['nama_mentor'] ?>" placeholder="Masukkan NAMA MENTOR" style="width: 74.5%;"></input>
        </div>
        <div class="form-group">
            <label for="telp_mentor"> NO. TELP </label>
            <span style="margin-left: 7%"> : </span>
            <input type="text" name="telp_mentor" value="<?php echo $data['telp_mentor'] ?>" placeholder="Masukkan NO. TELP" style="width: 74.5%;"></input>
        </div>
        <div class="form-group">
            <label for="jabatan"> JABATAN </label>
            <span style="margin-left: 7%"> : </span>
            <input type="text" name="jabatan" value="<?php echo $data['jabatan'] ?>" placeholder="Masukkan JABATAN" style="width: 74.5%;"></input>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            <input type="submit" href="mentor.php" name="simpan" value="SIMPAN" onclick="return confirm('Yakin Ingin Mengedit Data?')" style="margin-left:13%;"></input>
        </div>
        <div class="form-group">
            <input type="submit" href="mentor.php" name="batal" value="BATAL" onclick="return confirm('Yakin Ingin Membatalkan Edit Data?')" style="margin-left:13%;"></input>
        </div>
    </form>
</div>
<footer class="footer">
...
if(isset($_POST['simpan'])){
    ...
    mysqli_query($conn,"UPDATE tb_mentor 
    SET nip='$nip',nama_mentor='$nama_mentor',telp_mentor='$telp_mentor',jabatan='$jabatan',id_uk='$id_uk'
    WHERE id_mentor='$id'
