...
<div class="input">
    <form action="" method="POST" class="form-item">
        ...
        <div class="form-group">
            ...
            <span style="margin-left:7.5%"> : </span>
            <input type="date" name="selesai"></input>
        </div>
        <div class="form-group">
...
if(isset($_POST['simpan'])){
    ...
    mysqli_query($conn,"INSERT INTO tb_mahasiswa VALUES('','$nim','$nama_mhs','$prodi','$asal_instansi','$alamat','$no_telepon','$id_uk','$dospem','$mulai','$selesai','$id_mentor')
